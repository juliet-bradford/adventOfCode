...
solution = Solution(gridlines)

while solution.beams:
    solution.propogateBeam()

print("How many tiles end up being energized?", solution.energizedTiles())